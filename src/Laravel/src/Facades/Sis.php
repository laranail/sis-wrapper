 ...
 *
 * @method static \Simtabi\SIS\Identifier\Identifier reserve(\Simtabi\SIS\Identifier\IdClass $class, ?string $scope = null, string $reason = '', ?\Simtabi\SIS\Identifier\Actor $actor = null, int $width = 6)
 ...
 * @method static \Simtabi\SIS\Identifier\Identifier transitionTo(\Simtabi\SIS\Identifier\Identifier $identifier, \Simtabi\SIS\Identifier\LifecycleState $state, ?\Simtabi\SIS\Identifier\Actor $actor = null)
 ...
 * @method static \Simtabi\SIS\Command\Minter mint(\Simtabi\SIS\Identifier\IdClass $class)
 * @method static bool isValid(string $value)
 * @method static \Simtabi\SIS\Identifier\Identifier parse(string $value)
 * @method static \Simtabi\SIS\Identifier\IdClass|null classOf(string $value)
