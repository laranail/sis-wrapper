...
{
    public function next(ClassDefinition $class, ?string $scope): int
    {
        ...
        return DB::connection($connection)->transaction(function () use ($connection, $table, $code, $scopeKey, $start): int {
